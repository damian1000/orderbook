 ...
 * it. [io.github.damian1000.orderbook.market.MarketSession] is what provides that thread.
 *
 * Not an interface. There is one book, and a seam with a single implementation buys nothing but
 * indirection; [io.github.damian1000.orderbook.engine.Matcher] is where a genuine strategy seam
 * exists.
 */
class OrderBook {
